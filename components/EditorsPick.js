...
/**
 * TMDB has no real "editor's pick" endpoint, so fetchParams defaults to
 * top_rated movies as a stand-in curated list. Pass your own fetchParams
 * (or swap the fetch for a static list of ids) once you have real picks.
 */
const EditorsPick = ({
