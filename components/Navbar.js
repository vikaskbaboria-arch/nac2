...
{/* {till here} */}
           {session? ( <>
<button onClick={()=>setDropdown2(!dropdown2)} id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="bg-gradient-to-br from-purple-700 via-purple-800  inline-flex items-center justify-center text-white hover:bg-gradient-to-bl focus:ring-4  focus:outline-none focus:ring-purple-300 font-medium rounded-md text-sm px-4 py-2" type="button">
