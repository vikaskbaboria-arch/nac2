...
export function ReviewsSection({
  ...
  return (
    <section className={cn("bg-black   py-12  mt-12 sm:py-16", className)}>
      <div className="container-page">
      <h1 className="text-white pb-6 text-2xl ">Reviews worth Reading</h1>
        <div className="grid gap-4 md:grid-cols-3">
          {reviews.map((review) => (
            <ReviewCard key={review.id} review={review} onSaveChange={onSaveChange} />
          ))}
        </div>
      </div>
    </section>
